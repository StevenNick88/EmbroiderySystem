 ...
 */
public class Suxiudetail implements Serializable {
	...
	public String toString() {
		return "Suxiudetail [id=" + id + ", num=" + num + ", img1=" + img1
				+ ", detail1=" + detail1 + ", img2=" + img2 + ", detail2="
				+ detail2 + ", img3=" + img3 + ", detail3=" + detail3
				+ ", img4=" + img4 + ", detail4=" + detail4 + ", img5=" + img5
				+ ", detail5=" + detail5 + ", img6=" + img6 + ", detail6="
				+ detail6 + ", img7=" + img7 + ", detail7=" + detail7 + "]";
	}
	public Suxiudetail(int id, String num, String img1, String detail1,
			String img2, String detail2, String img3, String detail3,
			String img4, String detail4, String img5, String detail5,
			String img6, String detail6, String img7, String detail7) {
		super();
		this.id = id;
		this.num = num;
		this.img1 = img1;
